...
const forcast = (longitude , latitude , callback)=>{
    ...
    request({ url , json : true} , (error , {body})=>{
        if(error){
            ...
            callback(undefined , body.daily.data[0].summary + ' its currently ' + body.currently.temperature + ' degrees out. there is ' + body.currently.precipProbability + ' chance of rain')
        }
    })
}
